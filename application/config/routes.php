...
$route['entrytest']                                                 = 'user/dangkytest';
...
$route['carttesttest']                                         		= 'images/cart_test_test';
// Detail image
...
$route['invite-member/(:any)']										= 'user/invite_member/$1';
$route['accept-invite-member/(:any)']								= 'user/accept_invite_member/$1';
// User time line
...
$route['mypage/listagent']											= 'user/listagent';
$route['mypage/listagent/(:num)']									= 'user/listagent/$1';
$route['mypage/addmember']											= 'user/addmember';
$route['accept_member/(:any)']										= 'user/accept_member/$1';
$route['not_accept_member/(:any)']									= 'user/not_accept_member/$1';
// Json
