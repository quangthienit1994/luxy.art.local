...
class Admin extends MY_Admin {
    ...
    public function page_change_password_admin() {
        $data['title'] = "パスワード変更";
        $data['key_page'] = 'page_change_password_admin';
    ...
    public function page_list_email_tpl($page) { 
        ...
        $data['keyword'] = $search;
        $data['key_page'] = 'page_list_email_tpl';
    ...
    public function page_list_notification($page) { 
        ...
        $data['title'] = "お知らせ管理";
        $data['keyword'] = $search;
        $data['key_page'] = 'page_list_notification';
    ...
    public function page_list_setting($page) { 
        ...
        $data['title'] = "各種設定";
        $data['keyword'] = $search;
        $data['key_page'] = 'page_list_setting';
    ...
    public function page_list_country($page) { 
        ...
        $data['title'] = "都道府県管理";
        $data['keyword'] = $search;
        $data['key_page'] = 'page_list_country';
    ...
    public function page_list_category($page) { 
        ...
        $data['key_page'] = 'page_list_category';
    ...
    public function page_list_package($page) {
        ...
        $data['keyword'] = $search;
        $data['key_page'] = 'page_list_package';
