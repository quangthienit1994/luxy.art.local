	...
	public function post_image_test(){
		...
		if(isset($_POST['btnPostImage'])){
			...
			if($this->function_model->check_md5_file($md5_file) == 0){
				...
				$this->db->insert('luxyart_tb_product_img2', $dataAddProductImg);
				$id_img = $this->db->insert_id();
				...
				if($type_size_s != 0){
					$this->db->insert('luxyart_tb_product_img_size1', $dataInsertProductCategory);
				}
				echo $this->db->last_query()."<br>";
				...
				if($type_size_m != 0){
					$this->db->insert('luxyart_tb_product_img_size2', $dataInsertProductCategory);
				}
				echo $this->db->last_query()."<br>";
				...
				if($type_size_l != 0){
					$this->db->insert('luxyart_tb_product_img_size3', $dataInsertProductCategory);
				}
				echo $this->db->last_query()."<br>";
		...
		$this->template->load('default', 'post_image_test', $data, __CLASS__);
