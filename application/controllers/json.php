...
class Json extends CI_Controller
{
    ...
    public function list_image($item)
    {
        ...
        if ($user_level == 0) {
            ...
            $this->db->from('luxyart_tb_product_img');
            $this->db->join('luxyart_tb_user_get_img_sell', 'luxyart_tb_user_get_img_sell.id_img = luxyart_tb_product_img.id_img');
    ...
    public function search_image($item)
    {
        ...
        $this->db->select('`luxyart_tb_product_img`.*, (select count(luxyart_tb_user_bookmark_image.id_img) from luxyart_tb_user_bookmark_image where luxyart_tb_user_bookmark_image.id_img = luxyart_tb_product_img.id_img) as `states_count`, (select count(luxyart_tb_product_img_order_detail.id_img) from luxyart_tb_product_img_order_detail where luxyart_tb_product_img_order_detail.id_img = luxyart_tb_product_img.id_img) as `amount_buy`');
        $this->db->from('luxyart_tb_product_img');
        $this->db->where("img_check_status = 1  AND img_is_join_compe = 0 " . $condition_search);
        if ($type_order == 1) {
    ...
    public function post_image_method_post(){
    	...
    	$option_img_watermark 					= $_POST["option_img_watermark"];
    	$lang 									= 1;
    	$user_id 								= $_POST["user_id"];
    	$os_register 							= $_POST["option_img_watermark"];
