...
<header class="navbar navbar-fixed-top bg-light">
 ...
 <!--    <ul class="nav navbar-nav navbar-left">
        ...
        <li>
            <a class="topbar-menu-toggle cursor-hover">
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown dropdown-item-slide">
            ...
            <ul class="dropdown-menu dropdown-hover dropdown-persist pn w350 bg-white animated animated-shorter fadeIn" role="menu">
                ...
                <li class="p10 br-t item-1">
                    <div class="media">
                        <a class="media-left" href="#"> <img src="assets/admin/img/avatars/2.jpg" class="mw40" alt="holder-img"> </a>
                ...
                <li class="p10 br-t item-2">
                    <div class="media">
                        <a class="media-left" href="#"> <img src="assets/admin/img/avatars/3.jpg" class="mw40" alt="holder-img"> </a>
                        <div class="media-body va-m">
                            <h5 class="media-heading mv5">Article <small class="text-muted">- 08/16/22</small> </h5> Last Updated 36 days ago by
                            <a class="text-system" href="#"> Max </a>
                        </div>
                ...
                <li class="p10 br-t item-3">
                    <div class="media">
                        <a class="media-left" href="#"> <img src="assets/admin/img/avatars/4.jpg" class="mw40" alt="holder-img"> </a>
                        <div class="media-body va-m">
                            <h5 class="media-heading mv5">Article <small class="text-muted">- 08/16/22</small> </h5> Last Updated 36 days ago by
                            <a class="text-system" href="#"> Max </a>
                        </div>
                ...
                <li class="p10 br-t item-4">
                    <div class="media">
                        <a class="media-left" href="#"> <img src="assets/admin/img/avatars/5.jpg" class="mw40" alt="holder-img"> </a>
                        <div class="media-body va-m">
                            <h5 class="media-heading mv5">Article <small class="text-muted">- 08/16/22</small> </h5> Last Updated 36 days ago by
                            <a class="text-system" href="#"> Max </a>
                        </div>
        ...
        <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                <span class="lang-xs icon-lang-{{app()->getLocale()}}"></span>
                <span class="fw600">
                 {{config('cms.languages')[app()->getLocale()]['name']}} 
                 </span>
            </a>
            <ul class="dropdown-menu animated animated-short flipInX" role="menu">
            @foreach(config('cms.languages') as $value)
                <li>
                    <a href="{{route('Admin.lang',[$value['locale']])}}" class="fw600">
                        <span class="lang-xs icon-lang-{{$value['flag']}} mr10"></span> {{$value['name']}} </a>
                </li>
            @endforeach
            </ul>
        </li> -->
        <li class="ph10 pv20 hidden-xs"> 
            <i class="fa fa-circle text-tp fs8"></i>
        </li>
        <li class="dropdown">
            <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown"> <img src="publics/admin/img/avatars/1.jpg" alt="avatar" class="mw30 br64 mr15">
                <span>Admin</span>
                <span class="caret caret-tp hidden-xs"></span>
            </a>
            <ul class="dropdown-menu dropdown-persist pn w250 bg-white" role="menu">
                <!-- <li class="bg-light br-b br-light p8 hidden">
                ...
                <li class="br-t of-h">
                    <a href="admin/logout" class="fw600 p12 animated animated-short fadeInDown">
