...
<section class="content_box">
  <h3><?php echo $this->lang->line('add_picture'); ?></h3>
  <article class="member_edit">
    <h4><?php echo $this->lang->line('post_information'); ?></h4>
  ...
  <table class="table table-hover bg-white">
      ...
      <div class="edit_conts">
        <p><?php echo $this->lang->line('choose_user'); ?> <request></request></p>
        <p></p>
        <p>
      ...
      <div class="edit_conts">
        ...
        <p></p>
          <div class="radio-custom mb5">
          	<input type="radio" id="is_blur" name="type_export_image" value="1" checked>
            <label for="is_blur"><?php echo $this->lang->line('blur'); ?></label>
            <input type="radio" id="is_watermar" name="type_export_image" value="2">
            <label for="is_watermar"><?php echo $this->lang->line('watermark'); ?></label>
          </div>
      </div>
      
      <div class="edit_conts">
        <p><?php echo $this->lang->line('product_size'); ?> </p>
        <p></p>
        <div class="form-name">
      ...
      <div class="edit_conts">
        ...
        <p></p>
           <div class="radio-custom mb5">
            <input type="radio" id="hour" name="option_sale" value="1" checked>
            <label for="hour">24 <?php echo $this->lang->line('hour'); ?></label>
            <input type="radio" id="week" name="option_sale" value="2">
            <label for="week">1 <?php echo $this->lang->line('week'); ?></label>
            <input type="radio" id="month" name="option_sale" value="3">
            <label for="month">1 <?php echo $this->lang->line('month'); ?></label>
            <input type="radio" id="no_limit" name="option_sale" value="4">
            <label for="no_limit"><?php echo $this->lang->line('no_limit'); ?></label>
          </div>
      </div>
      <!--option_sale-->
      ...
      <div class="edit_conts">
        ...
        <div class="checkbox-custom mb5">
            <input type="checkbox" id="is_limit" name="is_limit" value="1">
            <label for="is_limit"><?php echo $this->lang->line('is_limit'); ?></label>
          </div>
      </div>
      <!--end is_limit-->
      ...
      <div class="edit_conts">
        <p><?php echo $this->lang->line('image_search_status'); ?> <request></request></p>
        <p></p>
        <p class="search_5">
      ...
      <div class="edit_conts">
        <p><?php echo $this->lang->line('image_size'); ?> <request></request></p>
        <p></p>
        <p>&nbsp;</p>
      </div>
      ...
      <table class="table">
        <tbody>
          <tr>
            <td>&nbsp;</td>
            <td><strong><?php echo $this->lang->line('unit_w'); ?></strong></td>
            <td><strong><?php echo $this->lang->line('unit_h'); ?></strong></td>
            <td><strong><?php echo $this->lang->line('unit_lux'); ?></strong></td>
          ...
          <tr>
            ...
            <td><input type="text" class="price product-size" id="type_size_width_s" name="type_size_width_s" value=""></td>
            <td><input type="text" class="price product-size" id="type_size_height_s" name="type_size_height_s" value=""></td>
            <td><input type="text" class="price product-size" id="type_size_point_s" name="type_size_point_s" value=""></td>
            <td><input type="text" class="price product-size" id="type_size_stock_s" name="type_size_stock_s" value=""></td>
          </tr>
          <tr>
            <td>
              <div class="checkbox-custom mb5" style="display:none;">
            ...
            <td><input type="text" class="price product-size" id="type_size_width_m" name="type_size_width_m" value=""></td>
            <td><input type="text" class="price product-size" id="type_size_height_m" name="type_size_height_m" value=""></td>
            <td><input type="text" class="price product-size" id="type_size_point_m" name="type_size_point_m" value=""></td>
            <td><input type="text" class="price product-size" id="type_size_stock_m" name="type_size_stock_m" value=""></td>
          </tr>
          <tr>
            <td>
              <div class="checkbox-custom mb5" style="display:none;">
            ...
            <td><input type="text" class="price product-size" id="type_size_width_l" name="type_size_width_l" value=""></td>
            <td><input type="text" class="price product-size" id="type_size_height_l" name="type_size_height_l" value=""></td>
            <td><input type="text" class="price product-size" id="type_size_point_l" name="type_size_point_l" value=""></td>
            <td><input type="text" class="price product-size" id="type_size_stock_l" name="type_size_stock_l" value=""></td>
          </tr>
        </tbody>
      </table>
      ...
      <div class="edit_button">
        <p></p>
        <p><input id="btnPostImage" name="btnPostImage" class="btn btn-primary" type="submit" value="<?php echo $this->lang->line('post_image'); ?>"></p>
      </div>
  </table>
</form>
