...
function load_product_tags(val_category, val_category_sub){
	...
	$.ajax({
		...
		data: "val_category="+val_category+"&val_category_sub="+val_category_sub+"&id_img="+id_img,
		success: function(data) {
...
<section class="content_box">
  <h3><?php echo $this->lang->line('edit_image'); ?></h3>
  <article class="member_edit">
    <h4><?php echo $this->lang->line('edit_information'); ?></h4>
