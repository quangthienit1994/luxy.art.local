	...
	<div id="photo_area">
		<div class="photo_c">
            ...
            <p style="text-align:center;padding-top:25px;">
            	<a onClick="rotate(-90);"><img width="28" height="28" src="publics/img/rotate_left.png" /></a>&nbsp;
            	<a onClick="rotate(90);"><img width="28" height="28" src="publics/img/rotate_right.png" /></a>
           	</p>
		</div>
...
function rotate(degree){
	...
	id_img = "<?php echo $get->id_img; ?>";
	
	$.ajax({
		type: "POST",
		cache: false,
		url: "<?php echo base_url(); ?>ajax/rotate",
		data: "id_img="+id_img+"&degree="+degree,
	...
	//$(".photos img").attr('src','http://imj01.luxy.art/1522913770-thumnail.jpg');
