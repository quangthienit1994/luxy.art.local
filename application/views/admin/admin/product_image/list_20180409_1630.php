...
<?php
  $listUserLevel = [
    1=>$this->lang->line('regular'),
    2=>$this->lang->line('creator'),
    3=>$this->lang->line('gold'),
    4=>$this->lang->line('platinum'),
    5=>$this->lang->line('enterprise'),
  ];
  $listImageStatus = [
...
<section class="content_box5">
    ...
    <article class="content5a">
      ...
      ?>
      <div class="imgs5"><p><a class="iframe" href="admin/image_info/<?=$value->id_img_abc?>" target="_blank"><img src="<?=$value->server_path_upload.'/'.$filename?>"  onerror="this.src='publics/product_img/image_default.png'"></a></p></div>
      <?php } ?>
    </article>
  </section>
