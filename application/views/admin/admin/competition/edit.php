...
<section class="content_box">
  ...
  <table class="table table-hover bg-white">
      ...
      <div class="edit_conts">
        <p><?php echo $this->lang->line('private_img_apply'); ?></p>
        <p></p>
          <div class="checkbox-custom mb5">
                <input <?=$get->is_private_img_apply==1?"checked=''":''?> id="is_private_img_apply" type="checkbox" name="is_private_img_apply"  value="1">
                <label for="is_private_img_apply"><?php echo $this->lang->line('private_img_apply'); ?></label>
            </div>
      </div>
