    	...
    	<?php foreach ($list as $key => $value) { ?>
     	<tr>
          ...
          <td class="text-center">
			...
			$count_apply = count($this->db->get_where('luxyart_tb_competition_img_apply', ['id_competition'=>$value->id_competition,'result_img'=>0])->result());
			//, 'luxyart_tb_competition_img_apply.result_img' => 0
