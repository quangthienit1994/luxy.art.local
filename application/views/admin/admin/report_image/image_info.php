				...
				<div class="photo_control">
					...
					*/?>
					...
					function reason_report($key) {
						...
						if(key == 1){
							echo $this->lang->line('possibility_of_violation');
						}
						elseif(key == 2){
							echo $this->lang->line('this_is_other_ones_image');
						}
						elseif(key == 3){
							echo $this->lang->line('violent_image');
						}
						elseif(key == 4){
							echo $this->lang->line('porn_image');;
						}
