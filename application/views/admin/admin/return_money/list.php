    ...
    <tbody>
    	<?php foreach ($list as $key => $value) { ?>
     	<tr>
        	...
        	<td><a target="_blank" href="admin/page_add_edit_user/<?=$value->user_id?>"><?=$value->user_firstname==''&&$value->user_lastname==''?$value->user_email:$value->user_lastname.' '.$value->user_firstname?></a></td>
