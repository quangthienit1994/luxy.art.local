            ...
            <div class="content_box3b">
              <table>
                ...
                <tr>
                  ...
                  <td class="text-center text-danger">
                    ...
                    <form action="admin/status_user_order/<?=$value->id_ordercredit?>" method="post" onsubmit="return submitAjax(this,{'load':1000})">
                        ...
                        <select class="form-control" name="status" style="width: 100px; margin: auto;" onchange="submitForm(this)">
                          <option <?=$value->payment_status==0?'selected=""':''?> value="0"><?php echo $this->lang->line('id'); ?>payment_waiting</option>
                          <option <?=$value->payment_status==1?'selected=""':''?> value="1"><?php echo $this->lang->line('id'); ?>payment_already_done</option>
                        </select>
                    </form>
                    <?php } ?>
                    <?php } ?>
                  ...
                  <td>
                    <?php
                    if($value->payment_menthod==2) echo $this->lang->line('id')master_visa_card;
                    elseif($value->payment_menthod==3) echo $this->lang->line('id')payment_bit_coin;
