...
onerror="this.src='<?=base_url('publics/avatar/default_avatar.png')?>'"></p>
      <p><?=$value->user_firstname==''&&$value->user_lastname==''?$value->user_email:$value->user_firstname.' '.$value->user_lastname?><br>投稿数:<?=count($this->db->get_where('luxyart_tb_product_img',['user_id'=>$value->user_id])->result());?></p>
      <p>
