...
<form enctype="multipart/form-data" action="admin/add_point_user" method="post">
  ...
  <div class="input-group col-lg-3">
  	<label><input type="text" name="rdTypePoint" value="1" />&nbsp;<?=$this->lang->line('lux_can_export'); ?></label>
    &nbsp;&nbsp;
    <label><input type="text" name="rdTypePoint" value="1" />&nbsp;<?=$this->lang->line('lux_cannot_export'); ?></label>
  </div>
