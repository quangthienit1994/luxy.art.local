...
<form enctype="multipart/form-data" action="admin/add_point_user" method="post">
  ...
  <div class="input-group col-lg-3">
    ...
    <textarea required="" style="width: 500px;" type="text" id="content_list_email" name="content" class="form-control" placeholder="<?=$this->lang->line('please_input_content'); ?>" ></textarea>&nbsp;&nbsp;
...
<form enctype="multipart/form-data" action="admin/add_point_user_type" method="post">
  ...
  <div class="input-group col-lg-3">
    ...
    <p class="search_2">
      ...
      <div style="clear:both">&nbsp;</div>
    <textarea required="" style="width: 500px;" type="text" id="content_membership_type" name="content" class="form-control" placeholder="<?=$this->lang->line('please_input_content'); ?>" ></textarea>&nbsp;&nbsp;
  </div>
