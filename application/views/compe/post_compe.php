...
var minimun_lux_post_competition = "<?php echo $minimun_lux_post_competition; ?>";
...
function validatePostCompe(){
	...
	if(total_com > 0){
		...
		if(total_com < minimun_lux_post_competition){
			msg = "<?php echo $this->lang->line('please_set_total_reward_more_than_compe_min'); ?>";
			msg = msg.replace("{minimun_lux}", minimun_lux_post_competition);
			show_msg("img_quantity_com",msg,1);
			set_focus("point_img_com");
			flag = 0;
			return false;
      ...
      <div class="contact-form">
        ...
        <form name="f" method="post" action="" enctype="multipart/form-data">
          ...
          <dl>
            ...
            <dd>
              <label><input type="checkbox" id="is_private" name="is_private" value="1" />&nbsp;<?php echo $this->lang->line('private_text'); ?></label>
            </dd>
