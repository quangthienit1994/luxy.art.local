...
<script type="text/javascript" src="<?php echo base_url(); ?>publics/test/jquery.montage.min.js"></script>
          ...
          <div class="category-sub__sp-cat">
            ...
            <select onchange="getval(this);">
              ...
              if(!empty($list_product_category))
			  {
				  ...
				  {
			  ?>
           <option value="<?php echo $detail_product_category->product_category_id; ?>" <?php if($detail_product_category->product_category_id == $cate_sosanh){echo 'selected="selected"';}?>><?php echo $detail_product_category->cate_name; ?></option>
            <?php } }?>
            </select>
            </div>
          ...
          <div class="list-search">
            ...
            <div class="list-search__form">
              <div class="list-search__text">
                <input id="key_search" name="key_search" type="text" placeholder="キーワードで検索" value="<?php if($search_key!="none" && $search_key!=""){echo $search_key;} else {echo '';}?>">
              </div>
            ...
            <div class="list-search__radio">
              <div>
                <label>
                  <input type="radio" name="cate" value="<?php echo $sosanh_cate_id?>">カテゴリ内を検索
                </label>
              </div>
              <div>
                <label>
                  <input type="radio" name="cate" value="all" checked="checked">すべてから検索
                </label>
              </div>
...
$('#pagesort').on('click','a',function(){
			...
			$(location).attr('href','<?php echo base_url();?>search?key_search='+ key_search +'&cate=<?php echo $sosanh_cate_id?>&typeimage%5B%5D=0&numpage='+id_pagesort);
	});
