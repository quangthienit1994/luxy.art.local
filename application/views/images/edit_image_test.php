    ...
    <div class="contents-mypage__wrapper clearfix">
      <div class="breadly">
        <ul>
          ...
          <li><span itemprop="title"><?php echo $this->lang->line('edit_image'); ?></span></li>
        </ul>
      </div>
      <?php $this->load->view('user/sidebar_user.php') ?>
      <div class="mypage-main">
        <h1 class="contents-mypage__find"><?php echo $this->lang->line('edit_image'); ?></h1>
        <div class="mypage-form">
          <form name="f" method="post" action="" enctype="multipart/form-data">
            ...
            <dl>
              ...
              <dd>
                <input type="text" id="img_title" name="img_title" maxlength="100" value="<?php echo isset($detail_product->img_title) ? $detail_product->img_title : ""; ?>" placeholder="<?php echo $this->lang->line('please_input_title_image'); ?>">
              ...
              <dd>
              	<?php
					if($detail_product->option_img_watermark == 1){
						echo '<label><input type="radio" id="is_blur" name="type_export_image" value="1" checked="checked">&nbsp;'.$this->lang->line('blur').'&nbsp;</label>';
						echo '<label><input type="radio" id="is_watermark" name="type_export_image" value="2">&nbsp;'.$this->lang->line('watermark').'</label>';
					}
					else if($detail_product->option_img_watermark == 2){
						echo '<label><input type="radio" id="is_blur" name="type_export_image" value="1">&nbsp;'.$this->lang->line('blur').'&nbsp;</label>';
						echo '<label><input type="radio" id="is_watermark" name="type_export_image" value="2" checked="checked">&nbsp;'.$this->lang->line('watermark').'&nbsp;</label>';
					}
				?><br />
            ...
            <input type="hidden" id="img_width" name="img_width" value="<?php echo isset($detail_product->img_width) ? str_replace("px", "", $detail_product->img_width) : ""; ?>" readonly="readonly">
            <input type="hidden" id="img_height" name="img_height" value="<?php echo isset($detail_product->img_height) ? str_replace("px", "", $detail_product->img_height) : ""; ?>" readonly="readonly">
            ...
            <dl>
              ...
              <dd>
                <div class="box-color">
                    <ul class="ul-box-color">
                        <?php
							/*foreach($list_product_color as $detail_product_color){
								if($detail_product->id_color == $detail_product_color->product_color_id){
									echo '<li id="color-'.$detail_product_color->product_color_id.'"><label class="label-select" for="color-'.$detail_product_color->name_color.'" style="background:'.$detail_product_color->css_color_style.'">&nbsp;</label><input id="color-'.$detail_product_color->name_color.'" value="'.$detail_product_color->product_color_id.'" type="checkbox"></li>';
								}
								else{
                    ...
                    <input type="hidden" id="id_color" name="id_color" value="<?php //echo isset($detail_product->id_color) ? $detail_product->id_color : 0  ?>" />
              ...
              <dd>
              	<?php
					if($detail_product->option_sale == 1){
						echo '<label><input type="radio" name="option_sale" value="1" checked="checked"> 24 '.$this->lang->line('hour').'</label>&nbsp;';
						echo '<label><input type="radio" name="option_sale" value="2"> 1 '.$this->lang->line('week').'</label>&nbsp;';
						echo '<label><input type="radio" name="option_sale" value="3"> 1 '.$this->lang->line('month').'</label>';
						echo '<label><input type="radio" name="option_sale" value="4"> '.$this->lang->line('no_limit').'</label>';
					}
					else if($detail_product->option_sale == 2){
						echo '<label><input type="radio" name="option_sale" value="1"> 24 '.$this->lang->line('hour').'</label>&nbsp;';
						echo '<label><input type="radio" name="option_sale" value="2" checked="checked"> 1 '.$this->lang->line('week').'</label>&nbsp;';
						echo '<label><input type="radio" name="option_sale" value="3"> 1 '.$this->lang->line('month').'</label>';
						echo '<label><input type="radio" name="option_sale" value="4"> '.$this->lang->line('no_limit').'</label>';
					}
						...
						echo '<label><input type="radio" name="option_sale" value="1"> 24 '.$this->lang->line('hour').'</label>&nbsp;';
						echo '<label><input type="radio" name="option_sale" value="2"> 1 '.$this->lang->line('week').'</label>&nbsp;';
						echo '<label><input type="radio" name="option_sale" value="3" checked="checked"> 1 '.$this->lang->line('month').'</label>';
						echo '<label><input type="radio" name="option_sale" value="4">'.$this->lang->line('no_limit').'</label>&nbsp;';
					}
						...
						echo '<label><input type="radio" name="option_sale" value="2"> 1 '.$this->lang->line('week').'</label>&nbsp;';
						echo '<label><input type="radio" name="option_sale" value="3"> 1 '.$this->lang->line('month').'</label>';
						echo '<label><input type="radio" name="option_sale" value="4" checked="checked"> '.$this->lang->line('no_limit').'</label>&nbsp;';
					}
				?>
              </dd>
              <!--end option_sale-->
              ...
              <dd>
              	<?php
					if($detail_product->is_limit == 0){
						echo '<label><input type="checkbox" id="is_limit" name="is_limit" value="1"> '.$this->lang->line('is_limit').'</label>';
					}
					else if($detail_product->is_limit == 1){
						echo '<label><input type="checkbox" id="is_limit" name="is_limit" value="1" checked="checked"> '.$this->lang->line('is_limit').'</label>';
					}
				?>
              </dd>
              <!--end is_limit-->
              ...
              <dd>
                  ...
                  <p style="padding:0 10px 0 0;display: contents"><input style="display:none;" type="checkbox" id="type_size_s" name="type_size_s" value="1"> <?php echo $this->lang->line('size_s'); ?>&nbsp;&nbsp;</p>  
                  <!--img_width-->
                  <div class="form-name__column">
                    <p><?php echo $this->lang->line('unit_w'); ?></p>
                    <input type="text" class="price product-size" id="type_size_width_s" name="type_size_width_s" value="<?php echo isset($list_product_img_size_s->type_size_width_s) ? $list_product_img_size_s->type_size_width_s : ""; ?>">
                  </div>
                  <!--end img_width-->
                  <!--img_height-->
                  <div class="form-name__column">
                    <p><?php echo $this->lang->line('unit_h'); ?></p>
                    <input type="text" class="price product-size" id="type_size_height_s" name="type_size_height_s" value="<?php echo isset($list_product_img_size_s->type_size_height_s) ? $list_product_img_size_s->type_size_height_s : ""; ?>">
                  </div>
                  <!--end img_height-->
                  <!--img_width-->
                  <div class="form-name__column">
                    <p><?php echo $this->lang->line('unit_lux'); ?></p>
                    <input type="text" class="price product-size" id="type_size_point_s" name="type_size_point_s" value="<?php echo isset($list_product_img_size_s->price_size_point) ? $list_product_img_size_s->price_size_point : ""; ?>">
                  </div>
                  <!--end img_width-->
                  <!--img_height-->
                  <div class="form-name__column">
                    <p><?php echo $this->lang->line('stock'); ?></p>
                    <input type="text" class="price product-size" id="type_size_stock_s" name="type_size_stock_s" value="<?php echo isset($list_product_img_size_s->size_stock) ? $list_product_img_size_s->size_stock : ""; ?>">
                  </div>
                  <!--end img_height-->
                  
                  <br /><p style="padding:0 10px 0 0;display: contents"><input style="display:none;" type="checkbox" id="type_size_m" name="type_size_m" value="2"> <?php echo $this->lang->line('size_m'); ?>&nbsp;</p>  
                  <!--img_width-->
                  <div class="form-name__column">
                    <p><?php echo $this->lang->line('unit_w'); ?></p>
                    <input type="text" class="price product-size" id="type_size_width_m" name="type_size_width_m" value="<?php echo isset($list_product_img_size_m->type_size_width_m) ? $list_product_img_size_m->type_size_width_m : ""; ?>">
                  </div>
                  <!--end img_width-->
                  <!--img_height-->
                  <div class="form-name__column">
                    <p><?php echo $this->lang->line('unit_h'); ?></p>
                    <input type="text" class="price product-size" id="type_size_height_m" name="type_size_height_m" value="<?php echo isset($list_product_img_size_m->type_size_height_m) ? $list_product_img_size_m->type_size_height_m : ""; ?>">
                  </div>
                  <!--end img_height-->
                  <!--img_width-->
                  <div class="form-name__column">
                    <p><?php echo $this->lang->line('unit_lux'); ?></p>
                    <input type="text" class="price product-size" id="type_size_point_m" name="type_size_point_m" value="<?php echo isset($list_product_img_size_m->price_size_point) ? $list_product_img_size_m->price_size_point : ""; ?>">
                  </div>
                  <!--end img_width-->
                  <!--img_height-->
                  <div class="form-name__column">
                    <p><?php echo $this->lang->line('stock'); ?></p>
                    <input type="text" class="price product-size" id="type_size_stock_m" name="type_size_stock_m" value="<?php echo isset($list_product_img_size_m->size_stock) ? $list_product_img_size_m->size_stock : ""; ?>">
                  </div>
                  <!--end img_height-->
                  
                  <br /><p style="padding:0 10px 0 0;display: contents"><input style="display:none;" type="checkbox" id="type_size_l" name="type_size_l" value="3"> <?php echo $this->lang->line('size_l'); ?>&nbsp;&nbsp;</p>  
                  <!--img_width-->
                  <div class="form-name__column">
                    <p><?php echo $this->lang->line('unit_w'); ?></p>
                    <input type="text" class="price product-size" id="type_size_width_l" name="type_size_width_l" value="<?php echo isset($list_product_img_size_l->type_size_width_l) ? $list_product_img_size_l->type_size_width_l : ""; ?>">
                  </div>
                  <!--end img_width-->
                  <!--img_height-->
                  <div class="form-name__column">
                    <p><?php echo $this->lang->line('unit_h'); ?></p>
                    <input type="text" class="price product-size" id="type_size_height_l" name="type_size_height_l" value="<?php echo isset($list_product_img_size_l->type_size_height_l) ? $list_product_img_size_l->type_size_height_l : ""; ?>">
                  </div>
                  <!--end img_height-->
                  <!--img_width-->
                  <div class="form-name__column">
                    <p><?php echo $this->lang->line('unit_lux'); ?></p>
                    <input type="text" class="price product-size" id="type_size_point_l" name="type_size_point_l" value="<?php echo isset($list_product_img_size_l->price_size_point) ? $list_product_img_size_l->price_size_point : ""; ?>">
                  </div>
                  <!--end img_width-->
                  <!--img_height-->
                  <div class="form-name__column">
                    <p><?php echo $this->lang->line('stock'); ?></p>
                    <input type="text" class="price product-size" id="type_size_stock_l" name="type_size_stock_l" value="<?php echo isset($list_product_img_size_l->size_stock) ? $list_product_img_size_l->size_stock : ""; ?>">
                  </div>
                  <!--end img_height-->
            ...
            <div class="mypage-form__btn">
              <input id="btnEditImage" name="btnEditImage" type="submit" value="<?php echo $this->lang->line('edit_image'); ?>">
            </div>
          </form>
        </div>
      </div>
