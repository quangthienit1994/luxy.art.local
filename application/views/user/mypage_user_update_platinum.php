        ...
        <div class="contents-leave__wrapper clearfix">
          <div class="breadly">
            <ul>
              ...
              <li><span itemprop="title"><?php echo $this->lang->line('update_account_user_platinum'); ?></span></li>
            </ul>
          </div>
          ...
          <?php if($show_buy_point==1){
			    $text_bien_notice_buy_more_point  = $this->lang->line('p_text_notice_user_buy_more_point_when_update_level_account');
			  	...
			  	$choidoi   = array($CI->check_level_user($user_level), $this->lang->line('user_level_4'),$point_user,$point_platinum - $point_user);
          ...
          <?php if($show_buy_point==0){
			  	...
			  	$choidoi   = array($point_platinum, $point_user);
