...
<div class="mypage-form" style="padding-bottom:5px;">
  ...
  <a class="tablinks active" href="<?php echo base_url(); ?>mypage/listinvited"><?php echo $this->lang->line('list_invited'); ?></a>
  <?php
  	if($user_level == 4){
  ?>
            ...
            <div class="mypage-purchase">
              ...
              <div class="mypage-purchase__list">
                <ul>
                  <?php
					if(!empty($list_invited)){
						...
						//if($user_id == 68){
							...
							$email_invite = $detail_invited->email_invite;
							$count = strlen($email_invite);
							...
							for($i=0; $i<$count; $i++){
								if(($i > 0) && ($email_invite[$i] != "@" || $email_invite[$i] != ".")){
									if($i==2 || $i==5 || $rand_bin[$i] == 1){
										$email_invite_new .= str_replace($email_invite[$i],"*",$email_invite[$i]);
									}
									else{
										$email_invite_new .= $email_invite[$i];
									}
								}
								else{
									$email_invite_new .= $email_invite[$i];
				  ...
				  ?>
                	<li>
                    <div class="date" style="width:110px !important;"><?php echo $email_invite_new; ?></div>
                    <div class="order">
						<?php
