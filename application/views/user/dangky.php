                    ...
                    <dl>
                      ...
                      <dd>
                      	<?php
							if(@$email_invite != ""){
						?>
                        <input id="re_email" name="email" type="text" placeholder="<?php echo $this->lang->line('p_dang_ky_form_email_placeholder'); ?>" value="<?php echo isset($email_invite) ? $email_invite : ""; ?>" readonly="readonly" >
                        <?php
							}
							else{
						?>
                        ...
                        <input type="hidden" id="invite_member" name="invite_member" value="<?php echo isset($invite_member) ? $invite_member : ""; ?>" />
