  ...
  <div class="entry-page__filter">
    ...
    <div class="entry-page__box">
      ...
      <div class="entry-page__box-inner">
        ...
        <h2 class="entry-page__find"><?php echo isset($meta_seo['return_title']) ? $meta_seo['return_title'] : $this->lang->line('notice'); ?></h2>

        <p><?php echo isset($meta_seo['return_msg']) ? $meta_seo['return_msg'] : ""; ?></p>

        <div class="link-btn"><a href="<?php echo isset($meta_seo['return_link']) ? @$meta_seo['return_link'] : ""; ?>"><?php echo $this->lang->line('click_here'); ?></a></div>
