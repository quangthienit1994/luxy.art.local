        ...
        <div class="contents-leave__wrapper clearfix">
          <div class="breadly">
            <ul>
              ...
              <li><span itemprop="title"><?php echo $this->lang->line('update_account_user_gold'); ?></span></li>
            </ul>
          </div>
          ...
          <?php if($show_buy_point==1){
			  	...
			  	$choidoi   = array($CI->check_level_user($user_level), $this->lang->line('user_level_3'),$point_user,$point_gold - $point_user);
          ...
          <?php if($show_buy_point==0){
			  	...
			  	$choidoi   = array($point_gold, $point_user);
