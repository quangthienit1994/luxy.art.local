...
class CI_Email {
	...
	var	$useragent		= "LuxyArt";
	var	$mailpath		= "/usr/sbin/sendmail";	// Sendmail path
	var	$protocol		= "smtp";	// mail/sendmail/smtp
	var	$smtp_host		= "smtp.luxyart.conoha.io";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "verification@luxy.art";		// SMTP Username
	var	$smtp_pass		= "1SMWVxF9ra";		// SMTP Password
