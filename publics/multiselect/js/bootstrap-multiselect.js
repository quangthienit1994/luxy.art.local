...
!function($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            filterPlaceholder: ''+text_search,
            // possible options: 'text', 'value', 'both'
            filterBehavior: 'text',
            preventInputChangeEvent: false,
            nonSelectedText: ''+text_none_selected,
            nSelectedText: ''+text_choose,
            numberDisplayed: 3
        },
        ...
        templates: {
            ...
            filter: '<div class="input-group"><span class="input-group-addon"><i class="fa fa-search" aria-hidden="true"></i></span><input class="form-control multiselect-search" type="text"></div>',
