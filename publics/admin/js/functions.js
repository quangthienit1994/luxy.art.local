if (typeof are_you_sure === 'undefined') {
    are_you_sure = "Ja Are you sure";
}

if (typeof you_will_not_be_able_to_recover === 'undefined') {
    you_will_not_be_able_to_recover = "Ja You will not be able to recover!";
}
...
var confirmSwal = {
  title: are_you_sure,
  text: you_will_not_be_able_to_recover,
  type: "warning",
